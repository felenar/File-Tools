...
static class Program
{
    ...
    static void Main()
    {
        ...
        if(args[2] != "singleD" && args[2] != "singleF") {
        ...
        } else if(args[2] == "singleD") Directory.CreateSymbolicLink(source + " (Sym)", source);
        else if(args[2] == "singleF") File.CreateSymbolicLink(source + " (Sym)", source);
    }    
}